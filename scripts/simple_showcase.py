...
try:
    ...
    total_inbound = InboundRecord.objects.aggregate(total=models.Sum('quantity'))['total'] or 0
    total_outbound = OutboundRecord.objects.aggregate(total=models.Sum('quantity'))['total'] or 0
